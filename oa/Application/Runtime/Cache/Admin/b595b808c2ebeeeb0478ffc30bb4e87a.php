    ...
    <div class="hd-wrap ue-clear">
      ...
      <div class="login-info ue-clear">
        ...
        <div class="login-msg ue-clear"> <a href="<?php echo U('Email/recbox');?>" target="iframe" class="msg-txt">消息</a>
          <a href="<?php echo U('Email/recbox');?>" target="iframe" class="msg-num">10</a> </div>
      </div>
        ...
        <ul class="nav">
          ...
          <li class="nav-info">
            ...
            <ul class="subnav">
              ...
              <li><a href="javascript:;" date-src="/index.php/Admin/User/add">添加职员</a></li>
            </ul>
          </li>
          <li class="konwledge">
