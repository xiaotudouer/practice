...
<div class="main">
    ...
    <p class="short-input ue-clear">
    	<label>描述：</label>
        <textarea id="ttt" name="description" style="font-family:Microsoft YaHei !important; font-size:14px;"></textarea>
    </p>
    <p class="short-input ue-clear">
    	<label>内容：
        ...
        <!--<textarea name="content" style="font-family:Microsoft YaHei !important; font-size:14px;" value="请输入内容..." ></textarea>-->
    </p>
</div>
...
$('#ttt').text('<?php echo ($data["description"]); ?>');
</script>
</html>